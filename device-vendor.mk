...
# 2015-5-18 oneplus longxiaowu@camera add start for 14001 start
MM_CAMERA += libmmcamera_ov5648
MM_CAMERA += libchromatix_ov5648_common
MM_CAMERA += libchromatix_ov5648_liveshot
MM_CAMERA += libchromatix_ov5648_preview
MM_CAMERA += libchromatix_ov5648_preview_fb
MM_CAMERA += libchromatix_ov5648_default_video
MM_CAMERA += libchromatix_ov5648_video_cmcc
MM_CAMERA += libchromatix_ov5648_zsl
MM_CAMERA += libchromatix_ov5648_zsl_fb
#imx214 for rear
...
MM_CAMERA += libchromatix_imx214_preview_binning
...
MM_CAMERA += libchromatix_imx214_video_binning
#2015-5-18 oneplus longxiaowu@camera add for 14001 end

# 2015-5-20 longxiaowu@camera add for 15055 start
MM_CAMERA += libmmcamera_s5k3m2
MM_CAMERA += libchromatix_s5k3m2_common
MM_CAMERA += libchromatix_s5k3m2_default_video
MM_CAMERA += libchromatix_s5k3m2_hfr_60fps
MM_CAMERA += libchromatix_s5k3m2_hfr_90fps
MM_CAMERA += libchromatix_s5k3m2_hfr_120fps
MM_CAMERA += libchromatix_s5k3m2_liveshot
MM_CAMERA += libchromatix_s5k3m2_preview
MM_CAMERA += libchromatix_s5k3m2_snapshot
MM_CAMERA += libchromatix_s5k3m2_video_hd
MM_CAMERA += libchromatix_s5k3m2_zsl
MM_CAMERA += libchromatix_s5k3m2_common_panorama
MM_CAMERA += libchromatix_s5k3m2_preview_panorama
MM_CAMERA += libchromatix_s5k3m2_snapshot_panorama
...
MM_CAMERA += libchromatix_ov8858_preview_binding
MM_CAMERA += libchromatix_ov8858_snapshot
MM_CAMERA += libchromatix_ov8858_liveshot
#muyuezhong@Camera,2015-11-2,add this for the process of lower layer for special app begin
MM_CAMERA += libchromatix_ov8858_small_video
#muyuezhong@Camera,2015-11-2,add this for the process of lower layer for special app end

MM_CAMERA += libmmcamera_s5k3l8

MM_CAMERA += libactuator_dw9800w
MM_CAMERA += libactuator_dw9800w_camera
MM_CAMERA += libactuator_dw9800w_camcorder
# 2015-5-20 longxiaowu@camera add for 15055 end
...
MM_CAMERA += libmmcamera_sunny_f13s01l_eeprom
MM_CAMERA += libmmcamera_sunny_p8v12b_eeprom
...
#ifndef VENDOR_EDIT
#2016/06/02, Delete qcom no use apk
